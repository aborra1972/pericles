...
- [x] **HW-B5** Control codec, mute, and WS2812 status LEDs. Verify each independently. _(mute ✅ both directions w/ physical cross-check; WS2812 rail ✅ register+physical; volume ✅ HOST-SIDE digital gain on I2S TX — Seeed r48 c11/c12 AIC3104 commands proved inert on i2s_dfu variant: reads st=42/st=41, writes no audible effect incl. 0. Amp pin X0D31 XMOS-owned. Gradient confirmed by ear 2026-08-21)_
