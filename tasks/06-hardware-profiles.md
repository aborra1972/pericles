...
- [ ] **HW-B2** Implement XVF3800 I2S audio adapter. Verify processed channel stream. _(implementation merged; on-device verification pending — audited 2026-08-21)_
- [ ] **HW-B3** Implement XVF3800 I2C control and version read. Verify real-device response. _(implementation merged; on-device verification pending — audited 2026-08-21)_
- [ ] **HW-B4** Expose VAD and DoA diagnostics. Verify direction and speech fixtures. _(implementation merged; on-device verification pending — audited 2026-08-21)_
- [ ] **HW-B5** Control codec, mute, and WS2812 status LEDs. Verify each independently. _(implementation merged; on-device verification pending — audited 2026-08-21)_
- [x] **HW-B6** Add XIAO 8 MB flash/8 MB PSRAM sdkconfig and size gate. Verify memory report.
- [ ] **HW-B7** Implement XVF3800 I2C DFU adapter. Verify Safe Mode recovery rehearsal. _(implementation merged; on-device verification pending — audited 2026-08-21)_
